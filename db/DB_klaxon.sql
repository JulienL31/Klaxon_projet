...
--
-- Host: localhost    Database: klaxon
-- ------------------------------------------------------
...
CREATE TABLE `trips` (
  ...
  KEY `trips_agency_from_fk` (`agency_from_id`),
  KEY `trips_agency_to_fk` (`agency_to_id`),
  KEY `trips_author_fk` (`author_id`),
...
-- Dump completed on 2025-09-30  9:05:01
